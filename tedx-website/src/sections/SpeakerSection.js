...
<div className="columns pt-3">
          <SpeakerCard 
          name = {<h2 class="is-size-3 has-text-weight-bold">Gennesaret Kharistio Tjusila</h2>}
          genne= {<img src={genne}/>}
          gennetext={<p>Genne merupakan salah satu manusia seksi yang lahir di kutub utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini, genne sedang menjalin hubungan asmara di negeri penuh cinta, jerman. Kita doain kuy biar lancar:)</p>}/>
          <SpeakerCard 
          name = {<h2 class="is-size-3 has-text-weight-bold">Angelica Alvetra</h2>}
          genne= {<img src={AngelicaAlvetra}/>}
          gennetext={<p>Genne merupakan salah satu manusia seksi yang lahir di kutub utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini, genne sedang menjalin hubungan asmara di negeri penuh cinta, jerman. Kita doain kuy biar lancar:)</p>}/>
          <SpeakerCard 
          name = {<h2 class="is-size-3 has-text-weight-bold">Cania Citta Irlanie</h2>}
          genne= {<img src={CaniaCitta}/>}
          gennetext={<p>Genne merupakan salah satu manusia seksi yang lahir di kutub utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini, genne sedang menjalin hubungan asmara di negeri penuh cinta, jerman. Kita doain kuy biar lancar:)</p>}/>
        </div>
<div className="columns pt-4">
          <SpeakerCard 
          name = {<h2 class="is-size-3 has-text-weight-bold">Clement Darmawan Setiabudhi</h2>}
          genne= {<img src={ClementDarwin}/>}
          gennetext={<p>Genne merupakan salah satu manusia seksi yang lahir di kutub utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini, genne sedang menjalin hubungan asmara di negeri penuh cinta, jerman. Kita doain kuy biar lancar:)</p>}/>
          <SpeakerCard 
          name = {<h2 class="is-size-3 has-text-weight-bold">Debryna Dewi Lumanauw</h2>}
          genne= {<img src={DebrynaLumanauw}/>}
          gennetext={<p>Debryna Dewi Lumanauw is an alumni of Maranatha University Bandung. Since becoming a doctor's assistant, he has created a community that serves as a social service. Even after graduating, she chose an internship not to popular cities, but rural areas. Doctor Debryna registered to become a volunteer doctor for the handling of COVID-19 patients at the COVID-19 Emergency Hospital Wisma Atlet Kemayoran on March 20, 2020. She dedicates herself to treating patients, whether patients under surveillance or PDP or those who are positively infected by the coronavirus. Until now, Doctor Debryna is still on duty and her workload is getting heavier. Previously, in 2017, when disasters occurred in several areas in Indonesia, she decided to join the National SAR Agency or Basarnas to become a volunteer doctor helping disaster victims.</p>}/>
          <SpeakerCard 
          name = {<h2 class="is-size-3 has-text-weight-bold">Karunya Sharma</h2>}
          genne= {<img src={KarunyaSharma}/>}
          gennetext={<p>Genne merupakan salah satu manusia seksi yang lahir di kutub utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini, genne sedang menjalin hubungan asmara di negeri penuh cinta, jerman. Kita doain kuy biar lancar:)</p>}/>
           <SpeakerCard 
           name = {<h2 class="is-size-3 has-text-weight-bold">Maurilla Sophianti Imron</h2>}
          genne= {<img src={Maurilla}/>}
          gennetext={<p>Genne merupakan salah satu manusia seksi yang lahir di kutub utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini, genne sedang menjalin hubungan asmara di negeri penuh cinta, jerman. Kita doain kuy biar lancar:)</p>}/>
        </div>
          ...
          <SpeakerCard
            ...
            gennetext={
              <p>
                Genne merupakan salah satu manusia seksi yang lahir di kutub
                utara. Sejak dini dia sudah diajarkan untuk menabung. Saat ini,
                genne sedang menjalin hubungan asmara di negeri penuh cinta,
                jerman. Kita doain kuy biar lancar:)
              </p>
            }
          />
                  <div className="columns pt-4">
